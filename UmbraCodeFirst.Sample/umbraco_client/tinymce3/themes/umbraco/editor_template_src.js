...
(function () {
    ...
    tinymce.create('tinymce.themes.umbracoTheme', {
        ...
        _addToolbars: function (c, o) {
            ...
            h.push(DOM.createHTML('a', { href: '#', accesskey: 'q', title: ed.getLang("umbraco.toolbar_focus") }, '<!-- IE -->'));
        ...
        _addStatusBar: function (tb, o) {
            ...
            n = DOM.add(n, 'div', { id: ed.id + '_path_row' }, s.theme_umbraco_path ? ed.translate('umbraco.path') + ': ' : '&nbsp;');
            DOM.add(n, 'a', { href: '#', accesskey: 'x' });

            if (s.theme_umbraco_resizing && !tinymce.isOldWebKit) {
                ...
                ed.onPostRender.add(function () {
                    Event.add(ed.id + '_resize', 'mousedown', function (e) {
                        ...
                        miw = s.theme_umbraco_resizing_min_width || 100;
                        mih = s.theme_umbraco_resizing_min_height || 100;
                        maw = s.theme_umbraco_resizing_max_width || 0xFFFF;
                        mah = s.theme_umbraco_resizing_max_height || 0xFFFF;
        ...
        _mceInsertAnchor: function (ui, v) {
            ...
            ed.windowManager.open({
                //url: tinymce.baseURL + '/themes/umbraco/anchor.aspx',
                url: tinyMCE.activeEditor.getParam('umbraco_path') + '/plugins/tinymce3/insertAnchor.aspx',
        ...
        _mceCharMap: function () {
            ...
            ed.windowManager.open({
                //url: tinymce.baseURL + '/themes/umbraco/charmap.aspx',
                url: tinyMCE.activeEditor.getParam('umbraco_path') + '/plugins/tinymce3/insertChar.aspx',
                width: 550 + parseInt(ed.getLang('umbraco.charmap_delta_width', 0)),
                height: 250 + parseInt(ed.getLang('umbraco.charmap_delta_height', 0)),
                inline: true
            }, {
                theme_url: this.url
            });
        ...
        _mceHelp: function () {
            ...
            ed.windowManager.open({
                url: tinymce.baseURL + '/themes/umbraco/about.htm',
                width: 480,
                height: 380,
                inline: true
            }, {
        ...
        _mceColorPicker: function (u, v) {
            ...
            ed.windowManager.open({
                url: tinymce.baseURL + '/themes/umbraco/color_picker.htm',
        ...
        _mceCodeEditor: function (ui, val) {
            ...
            ed.windowManager.open({
                url: tinymce.baseURL + '/themes/umbraco/source_editor.htm',
                width: parseInt(ed.getParam("theme_umbraco_source_editor_width", document.body.clientWidth - 100)),
                height: parseInt(ed.getParam("theme_umbraco_source_editor_height", document.body.clientHeight - 200)),
                inline: true,
                resizable: true,
                maximizable: true
            }, {
        ...
        _mceImage: function (ui, val) {
            ...
            ed.windowManager.open({
                url: tinymce.baseURL + '/themes/umbraco/image.htm',
        ...
        _mceLink: function (ui, val) {
            ...
            ed.windowManager.open({
                url: tinymce.baseURL + '/themes/umbraco/link.htm',
